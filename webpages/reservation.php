...
</title><meta http-equiv="x-ua-compatible" content="IE=9" /><style type="text/css">@import "http://www.xiaowaifood.com/App_Themes/_Default/s_default.css";</style><meta name="keywords" content="Yu's Asian Diner, Plano, 75075, Chinese, restaurant, discount, coupon, coupons, delivery, pickup, catering" /><meta name="description" content="View Yu's Asian Diner menu, Order Chinese Food Delivery Catering Online from Yu's Asian Diner, Best Chinese Delivery Catering in Plano, TX." /><style type="text/css">@import "http://www.xiaowaifood.com/CommonControl/UI/Message/jquery.jgrowl.css";</style>
...
<body>
    <center>
        <form name="aspnetForm" method="post" action="index.php" id="aspnetForm" class="form">
<div>
            ...
            <div class="body">
                ...
                <div class="menubar">
                    <table style='width: 100%; text-align: center;' cellpadding='0px' cellspacing='0px'>
                        ...
                        <td style="width:200px;" id = "signup">
                            <ul><li><a href="register.php" title="Sign Up"><span id = "signup1">Sign Up</span></nobr></a></li></ul>
                        </td> 
                            
                        <td style="width:200px;" id = "login">
                            <ul><li><a href="logIn.php" title="Log In"><span id = login1>Log In</span></nobr></a></li></ul>
                        </td>
...
<div class="storemessage">
   ...
   <p>Please choose your date: <input type="text" id="datepicker"></p>
            ...
            <div id="ctl00_pnlFooter" class="footer">
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td>
                            <p align="center" class="sitemap">&nbsp;</p>
                            <p align="center">
